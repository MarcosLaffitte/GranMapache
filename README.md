...
<div align="justify">
This repository contains useful tools callable as functions from Python scripts for the processing of constrained graph isomorphism problems and constrained maximum common induced subgraph searches over NetworkX graphs. Routines for finding exact solutions as well as heuristic approximations are implemented.
</div>
<br/>
