...
print("############################################")
print("\n")
print("> Anchored Progressive Graph Alignment Test with random topology and Exact MCS search")
...
print("############################################")
print("\n")
print("> Anchored Progressive Graph Alignment Test with random topology and Greedy MCS search")
...
print("############################################")
print("\n")
print("> Anchored Progressive Graph Alignment Test with kernel-induced topology and Exact MCS search")
...
print("############################################")
print("\n")
print("> Anchored Progressive Graph Alignment Test with kernel-induced topology and Greedy MCS search")
