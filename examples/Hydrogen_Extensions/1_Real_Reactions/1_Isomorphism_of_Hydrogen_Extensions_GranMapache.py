...
#                                                                              #
#  - 1 - Anchor isomorphism with GranMapache                                   #
#                                                                              #
################################################################################
        ...
        for each_permutation in permutations(extra_hydro_G):
            ...
            for each_class in all_classes_method_2:
                ...
                for each_automorphism in base_automorphisms:
                    ...
                    # test isomorphism
                    isomorphisms, are_isomorphic = gm.search_stable_extension(nx_G = hydro_ITS,
                                                                              nx_H = representatives_method_2[each_class][0],
                                                                              input_anchor = each_automorphism,
                                                                              node_labels = True,
                                                                              edge_labels = True,
...
# dump data
output_file = open("1_results.pickle", "wb")
...
# save figure
file_name = "1_anchored_iso_gm.pdf"
plt.savefig(file_name)
plt.close()
...
# save figure
file_name = "1_time_vs_classes_A.pdf"
plt.savefig(file_name)
plt.close()
...
# save figure
file_name = "1_time_vs_classes_B.pdf"
plt.savefig(file_name)
plt.close()
...
# save figure
file_name = "1_classes_without_labels.pdf"
plt.savefig(file_name)
plt.close()
...
# save figure
file_name = "1_classes_with_labels.pdf"
plt.savefig(file_name)
plt.close()
