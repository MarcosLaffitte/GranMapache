...
#                                                                              #
#  - 2 - Relabeling strategy with GranMapache                                  #
#                                                                              #
################################################################################
...
# dump data
output_file = open("2_results.pickle", "wb")
...
# save figure
file_name = "2_anchored_iso_gm.pdf"
plt.savefig(file_name)
plt.close()
...
# save figure
file_name = "2_time_vs_classes_A.pdf"
plt.savefig(file_name)
plt.close()
...
# save figure
file_name = "2_time_vs_classes_B.pdf"
plt.savefig(file_name)
plt.close()
...
# save figure
file_name = "2_classes_without_labels.pdf"
plt.savefig(file_name)
plt.close()
...
# save figure
file_name = "2_classes_with_labels.pdf"
plt.savefig(file_name)
plt.close()
