...
#                                                                              #
#  - 3 - Anchor isomorphism with Relabeling and NetworkX                       #
#                                                                              #
################################################################################
...
# dump data
output_file = open("3_results_random.pickle", "wb")
...
# save figure
file_name = "3_distribution_random.pdf"
plt.savefig(file_name)
plt.close()
